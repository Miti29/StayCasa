    ...
    <div id="content">
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                    	<h3 class="text-info">STAY CASA DETAILS</h3>
                    </div>
                   <div>
                    	<p>Welcome 
     ...
     <div class="modal fade" id="AddhotelModal" tabindex="-1" role="dialog" aria-labelledby="AdduserModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form action="/addhotelForm" modelAttribute="hotelForm"  method="POST" enctype= "multipart/form-data">
				...
				<input type="hidden" name="admin" value="not"/>
                <div class="modal-body">
                    ...
                    <div class="form-group">
						...
						<input  class="form-control"  type="text" name="price"  placeholder="Hotel Price" id="price" pattern="[0-9]{3}" required>
                    </div>
	...
	<script type="text/javascript">
        $(document).ready(function() {
            $('table .edit').click(function ()
            {
                ...
                $.ajax({
                    type: "GET",
                    url: "${pageContext.request.contextPath}/hotelfind/"+id,
