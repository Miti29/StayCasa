            ...
            <c:forEach var="allhotel" items="${hotellist}">
              <div class="col-md-6 col-sm-12">
                <div class="blockclass">
                  <img  src="data:image/jpeg;base64,${allhotel.hotelImg1}" alt="Thumbnail">
                </div>
                <div>
                  <p class="text-info text-center text-uppercase">${allhotel.hotelName}</p>
                  <p class="text-center">
                    <span class="price ">
                      <sup>Dollar</sup> 
                      <span class="number h1 text-info">${allhotel.price}</span> 
                  ...
                  <p class="pricing-text text-center">
                    <span>Location: ${allhotel.location}</span>                     
                  </p>
                  <span class="text-muted">${allhotel.hotelDesc}</span> 
                  <hr>
